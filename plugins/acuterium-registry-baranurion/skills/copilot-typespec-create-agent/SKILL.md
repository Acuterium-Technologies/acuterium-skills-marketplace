---
name: copilot-typespec-create-agent
...
<!-- Acuterium registry: baranurion-core | ACU-SKILL-2003 | category=agent-patterns | thread=T01 -->
...
- **File:** skills/typespec-create-agent/SKILL.md
